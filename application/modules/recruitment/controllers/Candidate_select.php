...
//                $zk->disconnect();
		...
		if ($this->form_validation->run() === true) {
			...
			$Data1 = [
				...
				'state'                      => $employee->state,
                        ...
                        $message  = 'Hi, you received this email because you are selected. Tap on the URL'
                                    . 'to accept your offer. '. base_url()."/recruitment/Candidate/candidate_select?"
                                . "id=".$employee_id."&name=".$employee->first_name." ".$employee->last_name."&role=".$Data1['pos_id'];
                        $headers  = 'From: charan1224@gmail.com' . "\r\n" .
                                    'MIME-Version: 1.0' . "\r\n" .
    ...
    public function update_acceptance() {
        $this->Selection_model->offer_acceptance($_GET['employee_id']);
