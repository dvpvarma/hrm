                            ...
                            <?php foreach ($caninfo as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                   ...
                                   <td>
                                    ...
                                    <td><a href="<?php echo base_url().$que->resume; ?>" target="_blank"><img src="<?php echo base_url()?>/application/modules/recruitment/assets/images/pdfIcon.png" style="height: 30px; width: 25px;"></a></td>
