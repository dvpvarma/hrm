                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" class="form-control" id="zip_code" name="zip_code" placeholder="<?php echo display('zip_code') ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                            <label for="picture" class="col-sm-3 col-form-label">Resume</label>
                            <div class="col-sm-9">
                                <input type="file" name="resume" class="form-control"  placeholder="resume" id="resume">
                            </div>
                        </div> 
...
if(f_name !== "" && email !=="" && phone !=="" && $("#picture").val() !== '' && $("#resume").val() !== ''){
